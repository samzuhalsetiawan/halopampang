...
export function Sidebar({ className, section, user }: SidebarProps) {
  return (
      ...
      <div className="space-y-4 py-4">
        <div className="px-3 py-2">
          ...
          <div className="space-y-1">
            <Button asChild variant={section == "JASA" ? "secondary" : "ghost"} className="w-full justify-start">
                <Link href={'/toko/jasa'}>
            ...
            <Button asChild variant={section == "MERCHANDISE" ? "secondary" : "ghost"} className="w-full justify-start">
            ...
            <Button asChild variant={section == "UMKM" ? "secondary" : "ghost"} className="w-full justify-start">
              <Link href={'/toko/umkm'}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
        ...
        { user?.uid === process.env.ADMIN_USERID && (
          <div className="px-3 py-2">
            ...
            <div className="space-y-1">
              <Button asChild variant={section == "ADMIN/ADD" ? "secondary" : "ghost"} className="w-full justify-start">
